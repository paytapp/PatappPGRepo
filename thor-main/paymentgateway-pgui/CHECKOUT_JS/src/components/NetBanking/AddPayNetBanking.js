...
class AddPayNetBanking extends PureComponent {
    state = {
        activeBank: '',
        displayError: false,
    }
                        ...
                        <form autoComplete="off" name="netBanking-form" method="post" target="_self" action={`${Window.baseUrl}/pay`} id="netBankingform" onSubmit={(e) => { return this.props.validateFormHandler(e, 'nbMopType', 'bankList'); }}>
                            ...
                            <Fade bottom duration={1400}>
                                <div className="row selectdiv mt-10">
                                    ...
                                    <input type="hidden" id="nbPaymentType" name="paymentType" value="WL" />                                    
                                    <input type="hidden" id="addMoneyPaymentType" name="addMoneyPaymentType" value="NB" />
...
export default AddPayNetBanking;