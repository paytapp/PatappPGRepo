                ...
                <div className="position-relative">
                    <label className={`custom-control-label position-relative d-flex align-items-center px-15 py-12 cursor-pointer`} htmlFor={props.item.key}>
                        ...
                        <span className="nb-icon rounded bg-white">
                            <img src={`${Window.basePath}/img/${props.item.value}.png`} alt={props.item.value} height="22" />
                        </span>

                        <span className="nb-text d-block font-size-14 ml-10">{Window.walletText[props.item.value]}</span>
                    </label>
