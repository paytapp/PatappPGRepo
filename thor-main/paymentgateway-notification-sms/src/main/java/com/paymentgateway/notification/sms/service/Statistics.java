...
public class Statistics implements Serializable {
	...
	private String totalSaleFailed;
	private String totalRefundFailed;
	
	private String totalSaleRejectedDeclined;
	private String totalRefundRejectedDeclined;
	private String totalSaleDropped;
	private String totalRefundDropped;
	private String totalSaleCancelled;
	private String totalRefundCancelled;
	private String refundedAmount;
	private String approvedAmount;
	private String totalSaleFraud;
	private String totalRefundFraud;
	private String totalSaleInvalid;
	private String totalRefundInvalid;
	// netbanking Summary
	...
	public String getTotalSaleFailed() {
		return totalSaleFailed;
	}

	public void setTotalSaleFailed(String totalSaleFailed) {
		this.totalSaleFailed = totalSaleFailed;
	}

	public String getTotalRefundFailed() {
		return totalRefundFailed;
	}

	public void setTotalRefundFailed(String totalRefundFailed) {
		this.totalRefundFailed = totalRefundFailed;
	}

	public String getTotalSaleRejectedDeclined() {
		return totalSaleRejectedDeclined;
	}

	public void setTotalSaleRejectedDeclined(String totalSaleRejectedDeclined) {
		this.totalSaleRejectedDeclined = totalSaleRejectedDeclined;
	}

	public String getTotalRefundRejectedDeclined() {
		return totalRefundRejectedDeclined;
	}

	public void setTotalRefundRejectedDeclined(String totalRefundRejectedDeclined) {
		this.totalRefundRejectedDeclined = totalRefundRejectedDeclined;
	}

	public String getTotalSaleDropped() {
		return totalSaleDropped;
	}

	public void setTotalSaleDropped(String totalSaleDropped) {
		this.totalSaleDropped = totalSaleDropped;
	}

	public String getTotalRefundDropped() {
		return totalRefundDropped;
	}

	public void setTotalRefundDropped(String totalRefundDropped) {
		this.totalRefundDropped = totalRefundDropped;
	}

	public String getTotalSaleCancelled() {
		return totalSaleCancelled;
	}

	public void setTotalSaleCancelled(String totalSaleCancelled) {
		this.totalSaleCancelled = totalSaleCancelled;
	}

	public String getTotalRefundCancelled() {
		return totalRefundCancelled;
	}

	public void setTotalRefundCancelled(String totalRefundCancelled) {
		this.totalRefundCancelled = totalRefundCancelled;
	}

	public String getTotalSaleFraud() {
		return totalSaleFraud;
	}

	public void setTotalSaleFraud(String totalSaleFraud) {
		this.totalSaleFraud = totalSaleFraud;
	}

	public String getTotalRefundFraud() {
		return totalRefundFraud;
	}

	public void setTotalRefundFraud(String totalRefundFraud) {
		this.totalRefundFraud = totalRefundFraud;
	}

	public String getTotalSaleInvalid() {
		return totalSaleInvalid;
	}

	public void setTotalSaleInvalid(String totalSaleInvalid) {
		this.totalSaleInvalid = totalSaleInvalid;
	}

	public String getTotalRefundInvalid() {
		return totalRefundInvalid;
	}

	public void setTotalRefundInvalid(String totalRefundInvalid) {
		this.totalRefundInvalid = totalRefundInvalid;
	}
