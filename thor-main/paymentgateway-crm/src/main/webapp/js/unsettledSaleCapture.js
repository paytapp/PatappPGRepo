...
function renderTable() {
	...
	$('#txnResultDataTable').dataTable({
		"ajax" : {
			...
			"url" : "unsettledTransactionSearchAction",
			"type" : "POST",
			"data" : function(d) {
...
$(document).ready(function(e){
	...
	function createDownloadForm(e){
		...
		if(_checkButton == "Download"){
			...
			document.querySelector("#downloadUnsettledTransactionsReportAction").innerHTML = _input;
			document.querySelector("#downloadUnsettledTransactionsReportAction").submit();	
		}else{
			document.querySelector("body").classList.remove("loader--inactive");
			var _obj = {};
