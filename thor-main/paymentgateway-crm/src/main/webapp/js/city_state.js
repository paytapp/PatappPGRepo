...
var _idSelector = document.getElementById.bind(document);

function populateStates(countryElementId, stateElementId, isDisabled) {
	var _country = _idSelector(countryElementId);
	
	var selectedCountryIndex = _country.selectedIndex;

    var stateElement = _idSelector(stateElementId);
    ...
    if(isDisabled !== undefined) {
        stateElement.disabled = isDisabled;
    }
}

function populateCountries(countryElementId, stateElementId) {
    // given the id of the <select> tag as function argument, it inserts <option> tags
    var countryElement = _idSelector(countryElementId);
    ...
    if (stateElementId) {
        countryElement.onchange = function () {
            if(countryElement.value !== "") {
                populateStates(countryElementId, stateElementId, false);
            } else {
                populateStates(countryElementId, stateElementId, true);
            }
        };
    }
}