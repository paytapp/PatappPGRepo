...
<head>
	...
	<title>Rupay Settlement Summary</title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Rupay Settlement Summary</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_input_group">
					<label for="">Settle Date From</label>
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_input_group">
					<label for="">Settle Date To</label>
