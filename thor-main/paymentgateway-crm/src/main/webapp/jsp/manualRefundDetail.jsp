    ...
    <body>
                    ...
                    <section class="manual-refund lapy_section white-bg box-shadow-box mt-70 p20">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="lpay_table_wrapper">
                                    <table class="lpay_custom_table" width="100%">
                                        ...
                                        <s:if test="%{manualRefundProcess.chargebackAmount != null && manualRefundProcess.chargebackAmount != '' && manualRefundProcess.chargebackAmount !='0.00'}">
                                            <tr>
                                                <td>Chargeback Amount</td>
                                                <td>
                                                    <s:property value="manualRefundProcess.chargebackAmount" />
                                                </td>
                                            </tr>
                                        </s:if>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Refund Amount</td>
                                            <td>
                                                <s:textfield type="text" name="refundAmount" step="0.01" id="refundAmount" autocomplete="off" class="form-control" placeholder="Enter Refund Amount" value="%{manualRefundProcess.refundAvailable}" onkeyup="onlyNumericKey(this, event, 2); limitAmount_alt(this, event);" onkeypress="onlyNumericKey(this, event, 2); limitAmount_alt(this, event);" />
                                                <s:textfield type="hidden" name="chargebackAmount" id="chargebackAmount" autocomplete="off" class="form-control" value="%{manualRefundProcess.chargebackAmount}" />
                                                <s:textfield type="hidden" name="chargebackStatus" id="chargebackStatus" autocomplete="off" class="form-control" value="%{manualRefundProcess.chargebackStatus}" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="col-md-12 text-center">
                                <span class="lpay_button lpay_button-md lpay_button-secondary" id="cancelButton" onclick="goBack()">Back</span>
                                <button class="lpay_button lpay_button-md lpay_button-primary" id="manualRefundButton" style="margin-top: 20px">Refund</button>
                            </div>
                            <!-- /.col-md-12 -->
                        </div>
                        <!-- /.row -->
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                if(_refundAvailable.val() == "0.00"){
                    document.querySelector("#refundAmount").setAttribute("readonly", true);
                    document.querySelector("#manualRefundButton").setAttribute("disabled", true);
                }
                ...
                $("#refundProcess").on("submit", function(e) {
                    ...
                    if(result) {
                        ...
                        var myData = {
                            ...
                            "chargebackAmount" : _id("chargebackAmount").value,
                            "chargebackStatus" : _id("chargebackStatus").value
                        }
                        if($("#reg").val() != ""){
