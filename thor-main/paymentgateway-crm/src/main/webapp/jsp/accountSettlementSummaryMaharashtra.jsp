...
<head>
	...
	<title>Bank of Maharashtra Settlement Summary</title>
			...
			$('#txnResultDataTable').dataTable(
				{
					...
					"ajax" :{
						...
						"url" : "accountSettlementSummaryMaharashtra",
						"type" : "POST",
						"data": function (d){
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Bank of Maharashtra Settlement Summary</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
