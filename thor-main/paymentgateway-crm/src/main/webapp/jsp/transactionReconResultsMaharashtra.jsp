...
<head>
	...
	<title>Bank of Maharashtra Transaction</title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Bank of Maharashtra Payment Filter</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_select_group">
					...
					headerKey="ALL"
						headerValue="ALL"
						class="selectpicker"
						list="#{'Captured':'Captured','Settled':'Settled','Captured and Settled':'Captured and Settled','Captured-Not Settled':'Captured-Not Settled','Post Settle Captured':'Post Settle Captured','Amount Mismatch':'Amount Mismatch'}"
						name="status"
						id="status"
						autocomplete="off"
						value="All"
	...
	<section class="transaction-result lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
					<h2 class="heading_text">Bank of Maharashtra Transaction List </h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
