...
<title>Reseller Merchant List</title>
...
<body class="bodyColor">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-20">
					<div class="lpay_select_group">
					   ...
					   <s:select class="selectpicker"
						id="resellerList" data-id="resellerList" data-live-search="true"
						headerKey="" headerValue="ALL" list="listReseller"
			...
			<div class="col-md-4 mb-20">
					<div class="lpay_select_group">
					   ...
					   <select id="merchant" data-id="reportMerchant" name = "merchantList" class="selectpicker">
    ...
    <s:hidden name="merchantList" value="%{merchantList}" id="merchantListFrm"></s:hidden>
    <s:hidden name="resellerList" value="%{resellerList}" id="resellerListFrm"></s:hidden>
    ...
    <s:form id="resellerMerchantDownload"  action="resellerMerchantDownload" >
        <s:hidden name="resellerList" id="reportResellerList" value=""></s:hidden>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(e){
            ...
            $(".downloadData").on("click", function(e){
            	if($("[data-id=resellerList]").val() == ""){
                    $("#reportResellerList").val("All");
                }else{
                    $("#reportResellerList").val($("[data-id=resellerList]").val());
                }
               ...
               // $("#subMerchant").val($("[data-id=subMerchant]").val());
                $("#resellerMerchantDownload").submit();
            })
            ...
            function generatePostData(d) {
            	var resellerId = $("#resellerList").val();
