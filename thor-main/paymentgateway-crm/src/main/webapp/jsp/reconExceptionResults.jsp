			...
			$('#txnResultDataTable').dataTable(
				{
					...
					"ajax" :{
						...
						"url" : "transactionReconExceptionAction",
						"type" : "POST",
						"data": function (d){
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Transaction Exceptions</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_select_group">
					...
					<s:select
						...
						headerValue="ALL"
						class="selectpicker"
						list="#{'AMEX':'AMEX','RUPAY':'RUPAY','IPAY':'IPAY','BOB':'BOB','AALAHABAD BANK':'AALAHABAD BANK','BANK OF INDIA':'BANK OF INDIA','BANK OF MAHARASHTRA':'BANK OF MAHARASHTRA','CORPORATION BANK':'CORPORATION BANK','HDFC':'HDFC','INDUSIND BANK':'INDUSIND BANK','KARUR BANK':'KARUR BANK','OBC':'OBC','PUNJAB NATIONAL BANK':'PUNJAB NATIONAL BANK','SYNDICATE BANK':'SYNDICATE BANK'}"
						name="acquirer"
						id="acquirer"
						autocomplete="off"
						value="All"
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_input_group">
					<label for="">Payment Date To</label>
	...
	<section class="transaction-result lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
					<h2 class="heading_text">Exceptions List </h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
					...
					<table id="txnResultDataTable" cellpadding="0" cellspacing="0" class="display" style="white-space: nowrap;" width="100%">
						<thead>
							<tr class="lpay_table_head">
								...
								<th style='text-align: center'>File Amount</th>
								<th style='text-align: center'>MPR Amount</th>
