...
.term-condition-text{ font-size: 12px;margin-left: 30px;margin-top: 15px;display: flex;align-items: center; }
.term-condition-text input{ margin-right: 10px;margin-top: 0; }
...
<body>
		...
		<div class="container">
			<div class="mpaLogo">
				<a href="#"> <img src="../image/white-logo.png"
					alt="Payment Gateway" width="120px">
				</a>
				<form id="mpaLogout" name="mpaLogout" method="post" action="logout">
					<input type="submit" id="button" class="lpay_button lpay_button-md lpay_button-primary logout-btn"
						value="Logout" />
				</form>
			</div>
			<!-- /.mpaLogo -->
							...
							<div class="row">
								...
								<div class="col-md-12 p-0">
									...
									<div class="mpaSectionFormTab stage-box active" id="stage-00">
										...
										<!-- col-md-3 -->
										<div class="col-md-12">
											<div class="mpaFormRow mpaFlex mpa-input mpa-input-alt align-item-center h-40"
										...
										<div class="col-md-12" data-type="Proprietory">
											...
											<div class="w-100">
												<div class="row">
													...
													<!-- /.col-md-4 -->
													<div class="col-md-8">
														<textarea name="" data-name="2" data-id="director1Address"
															cols="30" rows="10"
															class="mpaInput mpa-input mt-20 director-address"
															onchange="checkAllField(this)"></textarea>
														<p>Please click address box to fill address</p>
										...
										<div class="col-md-12">
											<form action="" enctype="multipart/form-data" id="fileUploadForm">
												<label class="fileUpload" for="uploadCheque"> <img
													...
													accept=".png, .pdf, .jpg, .jpeg"> <!-- <button class="mpaNext btn-stage">Upload</button> -->
												</label>
												<!-- /.fileUpload -->
											</form>
								...
								<div class="col-md-12 d-flex justify-content-center mt-30 button-wrapper">
								...
								<!-- /.col-md-12 -->
								<div class="col-md-12 d-flex justify-content-center mt-30 button-pdf">
	...
	<div class="modal fade esignWrapper" id="myModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
			  ...
			  <h4 class="modal-title">Merchant Agreement</h4>
			</div>
			<div class="modal-body">
				<div class="form-body" id="form-body">
					<!-- <form action="" method="post" enctype="multipart/form-data" id="documentUpload" class="upload-generic text-center">
						<label for="" class="generic-upload">
							<img src="../image/add-file.png" alt="" width="50"> <span><b>*</b> Upload Your sign</span> <input type="file" data-type="esign"
							name="eSignFile" accept=".png, .jpg, .pdf" class="documentUpload esign-control mpa-input">
						</label>
					</form> -->
					<div class="esignName">
						<div class="merchant__form_group">
							<label for="">Your Name <i>( As mentioned in aadhaar )</i><b class="imp">*</b></label>
							<input type="text" id="esignName" onkeypress="onlyLetters(event)"  class="merchant__form_control esign-control">
						  <!-- /.merchant__form_group -->
						  <span class="lpay_error"></span>
						</div>
						<!-- merchant form control -->
					</div>
					<!-- /.esignName -->
					<div class="modal-footer">
					  <button type="button" disabled id="esign" class="primary-btn">Submit</button>
					</div>
				</div>
				<!-- /.form-body -->
				<div class="from-response-data d-none merchantDetail-action">
					<div class="save-esign-data">
						<div class="save-text">
							<i class="fa fa-check-square-o" aria-hidden="true"></i>
							<span>Your Agreement is Completed Successfully.</span>
						</div>
					</div>
					<!-- /.save-esign-data -->
					<div class="merchantDetail-box">
						<span>Name</span>
						<div data-id="name">Mehboob Alam</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>YOB</span>
						<div data-id="yob">1993</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>Gender</span>
						<div data-id="gender">Male</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>Aadhar Type</span>
						<div data-id="aadhaarType">Personnal</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>UID Last Digit</span>
						<div data-id="uidLastFourDigits">4534</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>Country</span>
						<div data-id="country">India</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>State</span>
						<div data-id="state">Uttar Pradesh</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>PIN Code</span>
						<div data-id="pincode">208001</div>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
					<div class="merchantDetail-box">
						<span>Download Merchant Agreement</span>
						<div data-id="esignedFile" class="d-none">208001</div>
						<a href="#" target="_blank" id="esign-link" class="primary-btn">e-signed copy</a>
						<!-- /#companyName -->
					</div>
					<!-- merchantDetail-box -->
				</div>
	...
	<div class="term-condition-popup">
		<div class="term-condition-wrapper">
			<div class="term-condition-box" id="checkTerm">
				...
				<p>
					...
					ever since the 1500s, when an unknown printer <a
						href="\home\Properties\mpaTnC\tnc.pdf" download>click here for
						download</a>
				</p>
				<label for="termCondition" class="term-condition-input"> <input
					type="checkbox" id="termCondition"> I agree to the Payment Gateway
					term & condition
				</label>
				<!-- /.term-condition-input -->
				<div class="term-btn text-center">
					<button class="mpaNext" disabled>I understant let's
						proceed</button>
				</div>
				<!-- /.term-btn -->
			</div>
					...
					<div class="col-md-12 electircity-div varification-div">
						...
						<div class="mpa-form-group">
							<s:select headerKey="ALL" headerValue="Select Nodal Acquirer"
								class="form-control"
								list="@com.paymentgateway.commons.util.ElectricityBoardType@Values()"
