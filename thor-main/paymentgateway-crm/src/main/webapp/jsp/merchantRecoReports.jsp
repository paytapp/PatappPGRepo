                ...
                <div style="margin-top:20px;">
					...
					<div>
						 <form id="saleform" name="saleform" method="post" action="saleUploadAction" enctype="multipart/form-data">
						  <input name="file" id="file"  type="file" accept="text/*"  style="margin-left: -1%; margin-bottom: 3%;">
						  <button class="uploadButton" id="submit">Upload</button>
						</form>
				    </div>
            ...
            <form id="deltaRefund" name="deltaRefund" method="post" action="deltaRefundAction">
                <table class="table98 padding0 profilepage">
		            ...
		            <div class="form-group col-md-2 col-md-offset-2 txtnew col-sm-3 col-xs-6">
						...
						<s:if
							test="%{#session.USER.UserType.name()=='ADMIN' || #session.USER.UserType.name()=='SUBADMIN'  || #session.USER.UserType.name()=='SUBADMIN' || #session.USER_TYPE.name()=='SUPERADMIN'}">
							<s:select name="deltaMerchant" class="form-control" id="deltaMerchant"
					...
					<div class="form-group  col-md-2 col-sm-3 txtnew col-xs-6">
						...
						<s:textfield type="text" readonly="true" id="deltaDateFrom"
							name="deltaDateFrom" class="form-control" onchange="handleChange();" 
							autocomplete="off" style="margin-left: -28px !important; width: 120% !important;"/>
					</div>
					...
					<div>
						  ...
						  <button class="uploadButton" id="deltaDownloadBasic" onClick='submitDeltaRefundBasicForm()' style="width:22% !important;">Download with Basic</button>
						  <button class="uploadButton" id="deltaDownloadRRN" onClick='submitDeltaRefundRRNForm()' style="width:22% !important;">Download with RRN</button>
            ...
            <form id="refundValidation" name="refundValidation" method="post" action="refundValidationAction">
             <table class="table98 padding0 profilepage">
                <div style="margin-top:20px;">
					...
					<div class="form-group  col-md-2 col-sm-3 txtnew col-xs-6">
						...
						<s:textfield type="text" readonly="true" id="validationDateFrom"
							name="validationDateFrom" class="form-control" onchange="handleChange();" 
							autocomplete="off" style="margin-left: -28px !important; width: 120% !important;"/>
					</div>
				...
				<br>
					...
					<div>
					  <button class="uploadButton" id="refundValidationDownloadBasic" onClick='submitRefundValidationBasicForm() 'style="width:22% !important;">Download with Basic</button>
