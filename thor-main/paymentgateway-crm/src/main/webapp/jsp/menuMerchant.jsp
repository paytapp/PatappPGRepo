		...
		<ul id="navigation" class="nav side-menu">
			...
			<li><a class="head"> <span class="nav_icon"><i
				...
				<ul>
					...
					<%-- <s:if test="%{#session['USER_SETTINGS'].bookingRecord == true}"> --%>
					<li>
						<s:a action='bookingRecordSearch' data-page="Booking-Report">
					...
					<s:if test="%{#session['USER'].schoolManagement == true}">
						<li>
							<s:a action="schoolInventory" data-page="Student-List">
								<span class="nav_icon">SL</span>
								<span class="menu-text">Student List</span>
							</s:a>
						</li>
						<li>
							<s:a action="schoolReport" data-page="Student-Fee-Payment-Report">
								<span class="nav_icon">FPR</span>
								<span class="menu-text">Fee Payment Report</span>
							</s:a>
						</li>
					</s:if>
					...
					<s:if test="%{#session['USER_SETTINGS'].capturedMerchantFlag == true}">
						<li>
							<s:a data-page="Custom-Capture-Report"
					...
					<s:if test="%{#session['USER_SETTINGS'].customerQrFlag == true}">
						<li>
							<s:a data-page="Customer-QR-Report" action='customQrReport'>
