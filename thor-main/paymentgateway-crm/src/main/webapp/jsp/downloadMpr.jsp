...
<script src="../js/download-mpr-script.js"></script>
...
<body id="mainBody">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Download MPR</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
	...
	<s:form id="downloadTransactionsReportAction" name="downloadTransactionsReportAction" action="downloadMprAction">
