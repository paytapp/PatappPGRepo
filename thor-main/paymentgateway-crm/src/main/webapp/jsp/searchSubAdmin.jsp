			...
			.DataTable(
					{
						...
						"aoColumns" : [										
										...
										},	
										{
											...
											"bSortable" : false,
											"mRender" : function() {
												return '<button class="btn btn-info btn-xs lpay_button lpay_button-md lpay_button-secondary">Edit</button>';
											}
										},
										{
											"mData" : "payId",
...
<body>
	...
	<section class="sub-admin-list lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				<s:actionmessage />
			</div>
			...
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">Sub-admin List</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
