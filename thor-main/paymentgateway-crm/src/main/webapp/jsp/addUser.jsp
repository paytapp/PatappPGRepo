  ...
  <%@ taglib prefix="s" uri="/struts-tags" %>
    <%@taglib prefix="s" uri="/struts-tags" %>
      ...
      <body>
            ...
            <s:form action="addUserAction" id="frmAddUser">
              ...
              <div class="col-md-6 mb-20">
                <div class="lpay_input_group">
                  ...
                  <s:textfield name="firstName" id="fname" readonly="true" cssClass="lpay_input acquirer-input"
              ...
              <div class="col-md-6 mb-20">
                <div class="lpay_input_group">
                  ...
                  <s:textfield name="lastName" id="lname" readonly="true" cssClass="lpay_input acquirer-input"
                    autocomplete="off" onkeypress="noSpace(event,this);return isCharacterKey(event);" />
                  <div class="error-last error-subadmin">
              ...
              <div class="col-md-6 mb-20">
                <div class="lpay_input_group">
                  ...
                  <s:textfield name="businessName" id="businessName" cssClass="lpay_input acquirer-input"
                    autocomplete="off"
              ...
              <div class="col-md-6 common-validation mb-20">
                <div class="lpay_input_group">
                  ...
                  <div class="position-relative">
                    <s:textfield name="mobile" id="phoneNumber" readonly="true" cssClass="lpay_input acquirer-input"
                      autocomplete="off" onkeypress="javascript:return isNumber (event)" maxlength="10" />
              ...
              <div class="col-md-6 mb-20 common-validation">
                <div class="lpay_input_group">
                  ...
                  <div class="position-relative">
                    <s:textfield name="emailId" id="emailId" readonly="true" cssClass="lpay_input acquirer-input"
                      autocomplete="off" />
                    <img src="../image/right-tick.png" alt="/" class="right-tick status-img">
                    <img src="../image/wrong.png" alt="/" class="wrong-tick status-img">
                  </div>
                  ...
                  <s:iterator value="subUserPermissionType" status="itStatus">
                    <div class="col-md-3 mb-20">
                      <label class="checkbox-label unchecked" for="1">
                        ...
                        <s:checkbox name="lstPermissionType" id="%{permission}" class="common"
                          fieldValue="%{permission}" value="false" autocomplete="off"></s:checkbox>
                      </label>
                    </div>
                    <!-- /.col-md-4 -->
                  </s:iterator>
              ...
              <s:iterator value="listPermissionType" status="itStatus">
                <s:if test="%{permission == 'Booking Record'}">
                  <div class="col-md-3 mb-20 d-none" id="bookingPermission">
                    <label class="checkbox-label unchecked " for="1">
                      <s:property value="permission" />
                      <s:checkbox disabled="true" name="lstPermissionType" id="%{permission}" class="common"
                ...
                <s:elseif test="%{permission == 'View Transaction Reports'}">
                  <div class="col-md-3 mb-20" id="transactionPermission">
                    <label class="checkbox-label unchecked " for="1">
                      <s:property value="permission" />
                      <s:checkbox name="lstPermissionType" id="%{permission}" class="common" disabled="true"
                        fieldValue="%{permission}" value="false" autocomplete="off">
                      </s:checkbox>
                    </label>
                    <!-- /.checkbox-subadmin -->
                ...
                <s:elseif test="%{permission == 'Payout'}">
                    <s:if test="%{#session['USER'].merchantInitiatedDirectFlag == true}">
                ...
                <s:else>
                  <s:if test="%{permission == 'Account Verification'}">
                    ...
                    <s:elseif test="%{permission == 'Allow ePOS'}">
                      <div class="col-md-3 mb-20" id="allowEposFlag">
                        <label class="checkbox-label unchecked " for="1">
                          <s:property value="permission" />
                          <s:checkbox name="lstPermissionType" id="%{permission}" class="common" disabled="true"
                            fieldValue="%{permission}" value="false" autocomplete="off">
                  ...
                  <s:else>
                    <div class="col-md-3 mb-20">
                      <label class="checkbox-label unchecked " for="1">
                        <s:property value="permission" />
                        <s:checkbox name="lstPermissionType" id="%{permission}" disabled="true" class="common"
                          fieldValue="%{permission}" value="false" autocomplete="off">
                        </s:checkbox>
                      </label>
                      <!-- /.checkbox-subadmin -->
              ...
              <s:if test="%{eNachReport == true}">
                <div class="col-md-3 mb-20">
                  <label class="checkbox-label unchecked" for="eNachReport">
                    eNach Report
                    <s:checkbox name="lstPermissionType" id="eNachReport" disabled="true" class="common"
                      fieldValue="eNACH Report" value="false" autocomplete="off">
                    </s:checkbox>
                  </label>
                  <!-- /.checkbox-subadmin -->
                </div>
              ...
              <div class="col-md-12 text-center">
                <button disabled="true" id="submit" class="lpay_button lpay_button-md lpay_button-primary">Save
                  User</button>
              </div>
              <!-- /.col-md-12 -->
            </s:form>
        ...
        <s:hidden id="superMerchant" value="%{#session['USER'].superMerchant}"></s:hidden>

        <script>
          $(document).ready(function (e) {

            if ($("#superMerchant").val() == "true") {
              $("#subUserPermission").addClass("d-none");
            }
