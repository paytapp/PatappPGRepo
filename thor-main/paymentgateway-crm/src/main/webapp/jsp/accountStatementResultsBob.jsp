...
<head>
	...
	<title>BOB Account Statement Summary</title>
			...
			$('#txnResultDataTable').dataTable(
				{
					...
					"ajax" :{
						...
						"url" : "accountStatementSummaryBob",
						"type" : "POST",
						"data": function (d){
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					...
					<h2 class="heading_text">BOB Account Summary</h2>
				</div>
				<!-- /.heading_icon -->
			</div>
	...
	<section class="transaction-result lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
					<h2 class="heading_text">BOB Account Statement Summary </h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
