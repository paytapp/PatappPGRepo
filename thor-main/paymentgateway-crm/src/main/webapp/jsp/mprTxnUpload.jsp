...
function refreshWindow() {
	...
	var path = window.location.origin + "/crm/jsp/mprTxnUpload";
	...
	<section class="manage-hotel lapy_section white-bg box-shadow-box mt-70 p20">
				...
				<div class="col-md-12">
					<div class="heading_with_icon mb-30">
					  <span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
						<h2 class="heading_text">MPR Upload</h2>
					</div>
					<!-- /.heading_icon -->
				</div>
		...
		<section class="manage-hotel lapy_section white-bg box-shadow-box mt-70 p20">
			<div class="row">
				...
				<!-- /.col-md-12 -->
				<div class="col-md-4">
					<form action="mprReconDataManager" name="contact-form" method="post" id="uploadInvForm"
					...
					<input type="hidden" name="fileType" value="MPR"/>
