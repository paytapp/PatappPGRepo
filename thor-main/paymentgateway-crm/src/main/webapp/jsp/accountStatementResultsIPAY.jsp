...
<head>
	...
	<title>Account Statement Summary</title>
			...
			$('#txnResultDataTable').dataTable(
				{
					...
					"ajax" :{
						...
						"url" : "accountStatementSummaryIPAY",
						"type" : "POST",
						"data": function (d){
		...
		<div class="row">
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_select_group">
					...
					<s:select
						...
						headerValue=""
						class="selectpicker"
						list="#{'IRCTC ETicketing APP':'IRCTC ETicketing APP','IRCTC e ticketing':'IRCTC e ticketing'}"
						name="merchant"
						id="merchant"
						autocomplete="off"
						value="All"
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_select_group">
					...
					<s:select
						...
						headerValue="ALL"
						class="selectpicker"
						list="#{'IDBIBANK':'IDBIBANK','KOTAK':'KOTAK','MATCHMOVE':'MATCHMOVE','YESBANKCB':'YESBANKCB','ICICIMPGS':'ICICIMPGS'}"
						name="bank"
						id="bank"
						autocomplete="off"
						value="All"
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_input_group">
					<label for="">Payout Date From</label>
			...
			<div class="col-md-3 mb-20">
				<div class="lpay_input_group">
					<label for="">Payout Date To</label>
	...
	<section class="transaction-result lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				<div class="heading_with_icon mb-30">
					<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
					<h2 class="heading_text">Account Statement Summary </h2>
				</div>
				<!-- /.heading_icon -->
			</div>
			<!-- /.col-md-12 -->
					...
					<table id="txnResultDataTable" cellpadding="0" cellspacing="0" class="display" style="white-space: nowrap;" width="100%">
						<thead>
							<tr class="lpay_table_head">
								...
								<th style='text-align: center'>Settle Amount (A)</th>
								<th style='text-align: center'>Bank Statement Amount (B)</th>
								<th style='text-align: center'>Difference (A - B)</th>
								<th style='text-align: center'>Bank Narration</th>
							</tr>
						</thead>
					</table>
				</div>
