		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img
					src="../image/lpay.png" width="180"></a>
			</div>
				...
				<div class="sidebar-collapse">
					<ul id="navigation" class="nav side-menu">
						<li><s:a action='home' class="head1" >
								<i class="fa fa-home"></i> Dashboard</s:a></li>
						<li><a style="cursor: pointer" class="head"><i
								class="fa fa-bar-chart-o"></i> Transaction Summary <span
								class="fa fa-chevron-down"></span></a>
							<ul>
								<li><s:a action='authorizeTransaction' >Authorized</s:a></li>
								<li><s:a action='captureTransaction' >Captured</s:a></li>
								<li><s:a action='incompleteTransaction' >Incompleted</s:a></li>
								<li><s:a action='failedTransaction' >Failed</s:a></li>
							</ul></li>
						<li><a style="cursor: pointer" class="head"><i
								class="fa fa-pencil-square-o"></i> Reports <span
								class="fa fa-chevron-down"></span></a>
							<ul>
								<li><s:a action='summaryReport' >Summary</s:a></li>
								<li><s:a action='refundReport' >Refund</s:a></li>
								<li><s:a action='acquirerMisReports'>MIS Reports</s:a></li>	
							</ul></li>
							 <li><a style="cursor:pointer" class="head"><i class="fa fa-users"></i> Manage User <span class="fa fa-chevron-down"></span></a>
                                    <ul>
                                      <li><s:a action="addUser" >Add User </s:a>
                                        </li>
                                      <li><s:a action="searchUser" >User List</s:a>
                                        </li> 
