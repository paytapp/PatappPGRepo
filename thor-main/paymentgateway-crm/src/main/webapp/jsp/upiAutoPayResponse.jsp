	...
	<div class="eNACH-response">
		<div class="eNACH-response-box">
			<div class="eNACH-response-icon text-center">
				<s:if test="%{aaData.STATUS == 'Processing'}">
			...
			<div class="eNACH-reponse-msg">
				<s:if test="%{aaData.STATUS == 'Processing'}">
					<div class="success-msg">
						UPI AutoPay Registration has been completed
					</div>
					<!-- /.success-msg -->
				</s:if>
				<s:else>
					<div class="success-msg" style="color: #f00">
						UPI AutoPay Registration Failed
					</div>
					<!-- /.success-msg -->
				</s:else>
			</div>
			...
			<div class="eNACH-respone-data">
				<s:if test="%{aaData.PAYMENT_TYPE == 'UPI'}">
					...
					<div class="eNACH-respone-data-div">
						...
						<span><s:property value="%{aaData.PAYER_ADDRESS}" /></span>
					</div>
					<!-- /.eNACH-respone-data-div -->
					...
					<div class="eNACH-respone-data-div">
						...
						<span><s:property value="%{aaData.MONTHLY_AMOUNT}" /></span>
					</div>
					<!-- /.eNACH-respone-data-div -->
					<div class="eNACH-respone-data-div">
					...
					<div class="eNACH-respone-data-div">
						...
						<span><s:property value="%{aaData.DATE_FROM}" /></span>
					</div>
					<!-- /.eNACH-respone-data-div -->
					<div class="eNACH-respone-data-div">
						<span>Debit End Date</span>
						<span><s:property value="%{aaData.DATE_TO}" /></span>
					</div>
					<!-- /.eNACH-respone-data-div -->
				</s:if>
				<s:else>
        ...
        <s:form action="downloadUpiAutoPayRegistrationPdf" id="downloaPdfForm">
            <s:hidden id="orderId" value="%{aaData.ORDER_ID}" name="orderId"></s:hidden>
        </s:form>
	</div>
	<!-- /.eNACH-response -->
