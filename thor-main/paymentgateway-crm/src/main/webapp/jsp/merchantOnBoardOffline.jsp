...
<body>
	...
	<div class="onLoad-object">
		<div id="merchantPayId">
			<s:property value="%{payId}"></s:property>
		</div>
		<!-- /.merchantPayId -->
	</div>
	<!-- /.onLoad-object -->
	...
	<!-- /.mpaHeader -->
	<div
		style="width: 100%; max-width: 1200px; margin: auto; margin-bottom: 30px;">
		<section
			class="onboarding-merchant lapy_section white-bg box-shadow-box mt-70 p20">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="">
					<div class="row">
						...
						<div class="col-md-12 p-0">
												...
												<div class="col-md-4 mt-20 landline-div d-none">
													<div class="lpay_input_group">
														<label for="">Merchant Support Landline<b
															class="imp">*</b></label> <input type="text"
															id="merchantSupportLandLine" class="mpaInput mpa-input"
															onchange="checkAllField(this)" maxlength="11"
															onkeypress="onlyDigit(event)">
													</div>
													<!-- /.lpay_input_group -->
									...
									<form action="" enctype="multipart/form-data"
										...
										<label class="fileUpload" for="uploadCheque"> <img
											...
											class="file-msg">Upload Your Cheque Here <b
												class="imp">*</b></span> <input type="file" data-type="checque"
											id="uploadCheque" name="chequeFile" class="upload-file"
							...
							<div class="mpaSectionFormTab stage-box" id="stage-04">
								<div class="col-md-12">
									<div
										...
										<span class="w-30 formLabel">Merchant Type <b
											class="imp">*</b></span> <label class="pr-30"> <input
											type="checkbox" value="Regular Merchant"
											onchange="checkAllField(this)"> REGULAR MERCHANT
											...
											value="Brand EMI" onchange="checkAllField(this)">
											BRAND EMI
										</label>
									</div>
									<!-- /.mpa-input-alt -->
									<div
										...
										<span class="w-30 formLabel">Mode <b class="imp">*</b></span>
										<label class="paymentGatewayRadio"> TDR <input type="radio"
									...
									<div
										...
										<span class="w-30 formLabel">Integration Type <b
											class="imp">*</b></span> <label class="paymentGatewayRadio"> iFRAME
											<input type="radio" value="iFRAME" name="integration"
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
									...
									<div
										...
										id="customizedInvoiceDesign"
										data-key="customizedInvoiceDesign">
										<span class="w-30 formLabel">Customized Invoice Design
											<b class="imp">*</b>
										</span> <label class="paymentGatewayRadio"> YES <input type="radio"
											value="true" name="customize" onchange="checkAllField(this)">
											<span class="checkmark"></span>
									...
									<div
										...
										<span class="w-30 formLabel">Enable International Cards
											<b class="imp">*</b>
										</span> <label class="paymentGatewayRadio"> YES <input type="radio"
											value="true" name="international"
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
										</label> <label class="paymentGatewayRadio"> NO <input type="radio"
									...
									<div
										...
										<span class="w-30 formLabel">Allow Duplicate Refund
											Order ID <b class="imp">*</b>
										</span> <label class="paymentGatewayRadio"> YES <input type="radio"
											value="YES" name="refundOrderId"
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
										</label> <label class="paymentGatewayRadio"> NO <input type="radio"
											value="NO" name="refundOrderId"
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
										</label> <label class="paymentGatewayRadio"> NOT SURE <input
									...
									<div
										...
										<span class="w-30 formLabel">Allow Duplicate Sale
											OrderId In Refund <b class="imp">*</b>
										</span> <label class="paymentGatewayRadio"> YES <input type="radio"
									...
									<div
										class="mpa-input-alt w-50 mpa-input mpa-input mpa-input-alt"
							...
							<div class="mpaSectionFormTab stage-box" id="stage-05">
								...
								<div class="col-md-3">
									<label for="" class="w-100">Landline</label>
									<div class="mpaFormRow w-100">
										<input type="text" id="technicalContactLandline"
											maxlength="11" onkeypress="onlyDigit(event)"
											class="mpaInput landline-input"
											onchange="checkAllField(this)">
									</div>
									<!-- /.mpaFormRow -->
								</div>
								<!-- /.col-md-6 -->
								<div class="col-md-6 mt-15">
									<label for="" class="w-40">Server Details <b
										class="imp">*</b></label>
								...
								<!-- /.col-md-6 -->
								<div class="col-md-12">
									<p class="mb-10 default-font">If shared, please provide
								...
								<div class="col-md-6 mt-15 mb-10">
									...
									<div class="mpaFormRowRadio mpa-input mpa-input-alt"
										...
										<label class="paymentGatewayRadio pr-30"> 32 Bit <input
											...
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
										</label> <label class="paymentGatewayRadio"> 64 Bit <input
											type="radio" value="64" name="operating"
											onchange="checkAllField(this)"> <span
											class="checkmark"></span>
										</label>
									</div>
								...
								<!-- /.col-md-6 -->
								<div class="col-md-4">
									<label for="" class="w-100">Application Server
										Technology <b class="imp">*</b>
									</label>
									<div class="mpaFormRow w-100">
								...
								<!-- /.w-100 -->
								<div class="col-md-4">
									<label class="w-100">Production Server IP <b
										class="imp">*</b></label>
									<div class="mpaFormRow w-100">
									...
									<div class="mpaFormRow mpaFlex mpa-input mpa-input-alt"
										...
										<div class="mpaFormRowRadio" id="third-party-store">
											<label class="paymentGatewayRadio">Yes <input type="radio"
												value="YES" name="1" onchange="checkAllField(this)">
												<span class="checkmark"></span>
											</label> <label class="paymentGatewayRadio">No <input type="radio"
												value="NO" name="1" onchange="checkAllField(this)">
												<span class="checkmark"></span>
											</label>
										</div>
										<!-- /.mpaFormRowRadio -->
								...
								<div class="col-md-12 mt-30">
									<form action="" enctype="multipart/form-data"
										...
										<label class="fileUpload" for="uploadPdf"> <img
											src="../image/uploadFile.png" alt="/" width="100"
											height="100"> <span>Please upload your refund
												policy <small style="display: block;">(PDF Format |
													Size upto 2 MB) <b class="imp">*</b>
											</small>
										</span> <input type="file" id="uploadPdf" class="generic-uploader"
						...
						<div
							...
							<button id=""
								class="lpay_button lpay_button-md lpay_button-secondary">save
								as pdf</button>
							<!-- /.mpaPrev -->
							<!-- /.mpaPrev -->
						</div>
