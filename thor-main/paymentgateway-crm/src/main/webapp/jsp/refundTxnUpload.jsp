...
<html>
<head>
<title>Upload Refund Transactions</title>
	...
	.dataTable(
			{
				language: {
					search: "",
            searchPlaceholder: "Cancelled_Transactions"
        		},
				dom : 'BTftlpi',
				buttons : [ {
					extend : 'copyHtml5',
...
function refreshWindow() {
	...
	var path = window.location.origin + "/crm/jsp/refundTxnUpload";
				...
				<div class="col-md-12">
					<div class="heading_with_icon mb-30">
					  <span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
						<h2 class="heading_text">Refund Files</h2>
					</div>
					<!-- /.heading_icon -->
				</div>
		...
		<section class="manage-hotel lapy_section white-bg box-shadow-box mt-70 p20">
			<div class="row">
				<div class="col-md-12">
					<div class="heading_with_icon mb-30">
						<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
						<h2 class="heading_text">Files Upload</h2>
					</div>
					<!-- /.heading_icon -->
				</div>
				<!-- /.col-md-12 -->
				<div class="col-md-4">
					<form action="refundReconDataManager" name="contact-form" method="post" id="uploadInvForm"
					...
					<input type="hidden" name="fileType" value="REFUND"/>
				...
				<div class="button-wrapper lpay-center mt-20">
					...
					<table id="example" style="display: none;">
						<thead>
							<tr>
								<th>Refund Date (DD-MM-YYYY)</th>
								<th>Reservation Id</th>
								<th>Bank Transaction Number</th>
								<th>Cancel Date (DD-MM-YYYY)</th>
								<th>Amount</th>
								</tr>
						</thead>
					</table> 
