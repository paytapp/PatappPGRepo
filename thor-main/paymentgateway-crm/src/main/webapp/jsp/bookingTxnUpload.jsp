...
<html>
<head>
<title>Booking Transaction Upload</title>
	...
	.dataTable(
			{
				language: {
					search: "",
            searchPlaceholder: "Booking_Files"
        		},
				dom : 'BTftlpi',
				buttons : [ {
					extend : 'copyHtml5',
...
function refreshWindow() {
	...
	var path = window.location.origin + "/crm/jsp/bookingTxnUpload";
				...
				<div class="col-md-12">
					<div class="heading_with_icon mb-30">
					  <span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
						<h2 class="heading_text">Booking Files</h2>
					</div>
					<!-- /.heading_icon -->
				</div>
		...
		<section class="manage-hotel lapy_section white-bg box-shadow-box mt-70 p20">
			<div class="row">
				<div class="col-md-12">
					<div class="heading_with_icon mb-30">
						<span class="heading_icon_box"><i class="fa fa-bar-chart-o" aria-hidden="true"></i></span>
						<h2 class="heading_text">Upload Files</h2>
					</div>
					<!-- /.heading_icon -->
				</div>
				<!-- /.col-md-12 -->
				<div class="col-md-4">
					<form action="bookingReconDataManager" name="contact-form" method="post" id="uploadForm"
					...
					<input type="hidden" name="fileType" value="BOOKING"/>
