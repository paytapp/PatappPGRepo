...
import com.paymentgateway.crm.fraudPrevention.action.EditFraudRuleAction;
import com.paymentgateway.pg.core.fraudPrevention.model.FraudRuleModel;

public class UpdateFraudRuleAction extends AbstractSecureAction implements ModelDriven<FraudRuleModel> {
...
private String rowId;
		...
		private static Logger logger = LoggerFactory.getLogger(UpdateFraudRuleAction.class.getName());
		...
		public String execute() {
			...
			try {
				...
				responseObject = editFraudRuleAction.EditFraudRule(rowId,fraudRuleModel);
