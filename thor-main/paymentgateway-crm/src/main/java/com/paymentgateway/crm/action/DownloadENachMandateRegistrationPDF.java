 ...
 * @author Rajit
 */
public class DownloadENachMandateRegistrationPDF extends AbstractSecureAction {
	...
	private static final long serialVersionUID = -8068307692185733929L;
	private static Logger logger = LoggerFactory.getLogger(DownloadENachMandateRegistrationPDF.class.getName());
