...
public class DownloadB60SavedFile extends AbstractSecureAction {

	/**
	 * Download file from the location
	 */

	private static final long serialVersionUID = 5139161408842880839L;
	private static Logger logger = LoggerFactory.getLogger(DownloadB60SavedFile.class.getName());
	...
	public String execute() {
		...
		boolean dbexist = getFileStatus(fromDate, toDate, filename, ccCode);
		String zipLocation = "";
		if (ccCode != null) {
			zipLocation = "/home/Properties/tempFileLocation/zip/ccCodeZip/";
		} else {
			zipLocation = "/home/Properties/tempFileLocation/zip/main/";
		}
	...
	public boolean getFileStatus(String fromdate, String todate, String zipname, String ccCode) {
		...
		try {
			...
			if (ccCode != null) {
				BasicDBObject ccCodequery = new BasicDBObject(FieldType.CCCODE.getName(), ccCode);
				paramConditionLst.add(ccCodequery);
