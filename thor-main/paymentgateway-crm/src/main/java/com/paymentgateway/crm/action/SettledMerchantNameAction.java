 ...
 *
 */
public class SettledMerchantNameAction extends AbstractSecureAction {
	...
	private static Logger logger = LoggerFactory.getLogger(SettledMerchantNameAction.class.getName());
		...
		try {
			...
			if(sessionUser.getUserType().equals(UserType.ADMIN)
				...
				if(sessionUser.getUserType().equals(UserType.MERCHANT) && sessionUser.isSuperMerchant() == false
					...
					if(StringUtils.isNotBlank(identifierKey) && identifierKey.contains(sessionUser.getSuperMerchantId())) {
						setGlocalFlag(true);
					}
				}
				...
				if(sessionUser.getUserType().equals(UserType.SUBUSER) || sessionUser.getUserType().equals(UserType.SUBACQUIRER)){
					...
					if(parentMerchant.getUserType().equals(UserType.MERCHANT) && parentMerchant.isSuperMerchant() == false 
