...
public enum FraudRuleType {
	...
	BLOCK_DOMAIN_NAME			("3", "BLOCK_DOMAIN_NAME",FieldType.INTERNAL_CUST_IP.getName()),
	...
	WHITE_LIST_IP_ADDRESS		("11", "WHITE_LIST_IP_ADDRESS",FieldType.INTERNAL_CUST_IP.getName()),
	BLOCK_CARD_TXN_THRESHOLD	("10", "BLOCK_CARD_TXN_THRESHOLD",FieldType.CARD_NUMBER.getName()),
	BLOCK_TXN_VELOCITY			("12", "BLOCK_TXN_VELOCITY",FieldType.CARD_NUMBER.getName()),
	BLOCK_AMOUNT_VELOCITY		("13", "BLOCK_AMOUNT_VELOCITY",FieldType.AMOUNT.getName()),
	BLOCK_SALE_AMOUNT_VELOCITY	("14", "BLOCK_SALE_AMOUNT_VELOCITY",FieldType.AMOUNT.getName()),
	BLOCK_VPA					("15", "BLOCK_VPA",FieldType.VPA.getName()),
	BLOCK_VPA_TXN				("16", "BLOCK_VPA_TXN",FieldType.VPA.getName());
