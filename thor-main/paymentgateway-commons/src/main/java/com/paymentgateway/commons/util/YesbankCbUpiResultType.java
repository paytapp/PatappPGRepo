...
public enum YesbankCbUpiResultType {
	...
	YESUPI_RESP_P                                        ("P",   "003",   "Pending",              "Refund status is pending");
	...
	private YesbankCbUpiResultType(String bankCode, String paymentGatewayCode, String statusName, String message) {
