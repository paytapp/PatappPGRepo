...
@Service("safexpayProcessor")
public class SafexpayProcessor implements Processor {

	@Autowired
	private SafexpayIntegrator safexpayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.SAFEXPAY.getCode())) {
			return;
		}
		...
		safexpayIntegrator.process(fields);
