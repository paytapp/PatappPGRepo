...
public class Transaction {
	...
	public void setOrgResponse(String orgResponse) {
	...
	public void setOrgCustRefId(String orgCustRefId) {
		OrgCustRefId = orgCustRefId;
	}
