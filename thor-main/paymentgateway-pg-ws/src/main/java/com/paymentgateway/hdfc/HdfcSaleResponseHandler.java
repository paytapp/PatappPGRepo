...
@Service
public class HdfcSaleResponseHandler {

	private static Logger logger = LoggerFactory.getLogger(HdfcSaleResponseHandler.class.getName());
	...
	@Autowired
	private HdfcTransformer hdfcTransformer;
	...
	public Map<String, String> process(Fields fields) throws SystemException {
		...
		String xmlResponse = fields.get(FieldType.HDFC_RESPONSE_FIELD.getName());
		...
		fields.remove(FieldType.HDFC_RESPONSE_FIELD.getName());
	...
	public Transaction toTransaction(String xml) {
		...
		if ((StringUtils.isNotBlank(result)) && (!result.equalsIgnoreCase("FSS0001-Authentication Not Available."))) {
