 ...
 *
 */
@Service("digitalsolutionTransactionCommunicator")
public class TransactionCommunicator {
	...
	public void updateSaleResponse(Fields fields, String paymentUrl) {
		...
		fields.put(FieldType.DIGITALSOLUTION_FINAL_REQUEST.getName(), paymentUrl);
	...
	public String refundPostRequest(String request, String hostUrl) throws SystemException {
		...
		// Refund is not supported by Digital Solution
		String response = "";
		return response;
	}

	public String statusEnqPostRequest(String hostUrl,String request) throws SystemException {
		String stringResponse = "";
		HttpsURLConnection connection = null;
		try {
			
			logger.info("Status Enquiry Request URL for Digital Solution : " + hostUrl);
			...
			logger.info("Status Enquiry Response for Digital Solution :{} ",str);
			return str;

		} 
		catch (Exception e) {
			logger.error("Exception in getting Status Enquiry respose for Digital Solution", e);
		}
	...
	public String getPaymentResponse(String request,Fields fields) throws SystemException {
		...
		try {
			...
			saleUrl.append(propertiesManager.propertiesMap.get(Constants.DIGITALSOLUTION_SALE_URL));
			...
			logger.error("Exception in getting payment URL response for Digital Solution", e);
		}
		return stringResponse;
	}
