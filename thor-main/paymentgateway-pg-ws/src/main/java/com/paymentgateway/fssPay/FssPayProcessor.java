...
@Service("fssPayProcessor")
public class FssPayProcessor implements Processor {

	@Autowired
	private FssPayIntegrator fssPayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.FSSPAY.getCode())) {
			return;
		}
		...
		fssPayIntegrator.process(fields);
