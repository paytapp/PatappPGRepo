...
@Service("qaicashProcessor")
public class QaicashProcessor implements Processor {

	@Autowired
	private QaicashIntegrator qaicashIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.QAICASH.getCode())) {
			return;
		}
		...
		if (paymentType.equals(PaymentType.UPI.getCode()) && mopType.equals(MopType.GOOGLEPAY.getCode())) {
			...
			qaicashIntegrator.process(fields);
