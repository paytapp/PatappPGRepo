...
@Service
public class QaicashTransformer {

	private Transaction transaction = null;

	public QaicashTransformer(Transaction transaction) {
	...
	public void updateResponse(Fields fields) {
		...
		if ((StringUtils.isNotBlank(transaction.getStatus()))
			...
			if (StringUtils.isNotBlank(transaction.getStatus())) {
				...
				QaicashResultType resultInstance = QaicashResultType
