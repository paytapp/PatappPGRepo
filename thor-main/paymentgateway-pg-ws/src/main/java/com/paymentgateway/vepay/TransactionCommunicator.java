...
@Service("vepayTransactionCommunicator")
public class TransactionCommunicator {
	...
	public void updateSaleResponse(Fields fields, String request) {
		...
		fields.put(FieldType.VEPAY_FINAL_REQUEST.getName(), request.toString());
	...
	public String getResponse(String request, Fields fields) throws SystemException {
		...
		try {
				...
				hostUrl = PropertiesManager.propertiesMap.get(Constants.VEPAY_REFUND_URL);
				logger.info("VePay Refund URL >> " +hostUrl);
				...
				logger.info("Response received for VePay Refund  >> " + response);
				...
				throw new SystemException(ErrorType.INTERNAL_SYSTEM_ERROR, ioException,
						"Network Exception with Vepay for refund request " + hostUrl.toString());
