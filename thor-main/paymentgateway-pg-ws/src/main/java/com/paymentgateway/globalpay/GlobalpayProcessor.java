...
@Service("globalpayProcessor")
public class GlobalpayProcessor implements Processor {

	@Autowired
	private GlobalpayIntegrator globalpayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.GLOBALPAY.getCode())) {
			return;
		}
		...
		if (paymentType.equals(PaymentType.UPI.getCode()) && mopType.equals(MopType.GOOGLEPAY.getCode())) {
			...
			globalpayIntegrator.process(fields);
