...
@Service("grezpayProcessor")
public class GrezpayProcessor implements Processor {

	@Autowired
	private GrezpayIntegrator grezpayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.GREZPAY.getCode())) {
			return;
		}
		...
		grezpayIntegrator.process(fields);
