...
@Service("cashfreeProcessor")
public class CashfreeProcessor implements Processor {

	@Autowired
	private CashfreeIntegrator cashfreeIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.CASHFREE.getCode())) {
			return;
		}
		cashfreeIntegrator.process(fields);
	}
