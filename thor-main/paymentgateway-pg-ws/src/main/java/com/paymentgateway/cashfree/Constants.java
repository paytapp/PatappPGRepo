...
public class Constants {
	...
	public static final String SALE_RETURN_URL = "CASHFREEReturnUrl";
	...
	public static final String card_expiryMonth = "card_expiryMonth";
	public static final String card_expiryYear = "card_expiryYear";
	...
	public static final String REFUND_REQUEST_URL = "CASHFREERefundUrl";
	public static final String STATUS_ENQ_REQUEST_URL = "CASHFREEStatusEnqUrl";
	
	public static final String paymentOptionUPI = "upi";
	...
	public static final String VPA_VERIFY_URL = "VPAVerifyUrl";
	public static final String CREATE_ORDER_TOKEN_URL = "CREATEOrderTokenUrl";
	public static final String PAY_ORDER_URL = "PAYOrderUrl";
	public static final String ORDER_STATUS_URL = "ORDERStatusUrl";
}
