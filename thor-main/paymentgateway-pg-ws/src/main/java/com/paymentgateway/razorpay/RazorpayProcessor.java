...
@Service("razorpayProcessor")
public class RazorpayProcessor implements Processor {

	@Autowired
	private RazorpayIntegrator razorpayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.RAZORPAY.getCode())) {
			return;
		}
		...
		razorpayIntegrator.process(fields);
