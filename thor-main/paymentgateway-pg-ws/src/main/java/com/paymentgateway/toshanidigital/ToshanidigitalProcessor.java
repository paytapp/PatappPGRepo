...
@Service("toshanidigitalProcessor")
public class ToshanidigitalProcessor implements Processor {

	@Autowired
	private ToshanidigitalIntegrator toshanidigitalIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.TOSHANIDIGITAL.getCode())) {
			return;
		...
		toshanidigitalIntegrator.process(fields);
