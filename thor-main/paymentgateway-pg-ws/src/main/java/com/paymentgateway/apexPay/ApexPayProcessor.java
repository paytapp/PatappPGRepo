...
@Service("apexPayProcessor")
public class ApexPayProcessor implements Processor {

	@Autowired
	private ApexPayIntegrator apexPayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.APEXPAY.getCode())) {
			return;
		}
		...
		apexPayIntegrator.process(fields);
