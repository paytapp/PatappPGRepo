...
@Service
public class ApexPayIntegrator {
	...
	@Autowired
	@Qualifier("apexPayTransactionCommunicator")
	...
	public void send(Fields fields) throws SystemException {
		...
		if (txnType.equals(TransactionType.SALE.getName())) {
			...
			String response = communicator.getResponse(request, fields);
			 ...
			 ApexPayTransformer  apexPayTransformer = new ApexPayTransformer(transactionResponse);
			 apexPayTransformer.updateRefundResponse(fields);
		}
