...
public class ConstantsPaymentGateway {
	...
	public static final String BINNO = "bin_no";
	...
	public static final String PAYMENT_GATEWAY_KEY = "PaymentGatewayKey";
	public static final String PAYMENT_GATEWAY_IV = "PaymentGatewayIv";
	public static final String HDFC_UPI_AES_UTIL= "hdfcUpiAesUtil";
}
