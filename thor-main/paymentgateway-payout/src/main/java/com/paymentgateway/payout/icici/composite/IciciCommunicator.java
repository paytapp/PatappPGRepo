...
public class IciciCommunicator {
	...
	public String getCibResponse(String request, String url, Fields fields) throws IOException {
		...
		try {
			...
			logger.info("Encrypted Request is " + encryptedRequest +" Txn Id "+fields.get(FieldType.TXN_ID.getName())+" "+fields.getFields());
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				in.close();
				logger.info("Encrypted CIB response recived is " + response, toString()+" Txn Id = "+fields.get(FieldType.TXN_ID.getName())+" "+fields.getFields());
				...
				logger.info("Decrypted Response of ICICI CIB is " + decryptedResponse+" Txn Id =  "+fields.get(FieldType.TXN_ID.getName()));
				return decryptedResponse;

			} else {
				logger.info("Error while connecting. Response Code is " + con.getResponseCode()+" Txn Id = "+fields.get(FieldType.TXN_ID.getName()));
	...
	public String getIciciCompositeApiResponse(String request, String url, Fields fields, String priorty, String apiKey, JSONObject adfFields)
			throws IOException {
		String decryptedResponse = null;
		...
		try {
			...
			String encryptedRequest = iciciUtil.compositeApiEncryption(request,adfFields);
			logger.info(
					"Composite Encrypted Request is " + encryptedRequest + " Txn Id =  " + fields.get(FieldType.TXN_ID.getName()));
			...
			int responseCode = con.getResponseCode();
			logger.info("Composite Response Code " + responseCode + " Txn Id =  " + fields.get(FieldType.TXN_ID.getName()));
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				if(StringUtils.isNotBlank(fields.get(FieldType.REQUEST_TYPE.getName()))){
					...
					decryptedResponse = iciciUtil.compositeApiBeneDecryption(response.toString(),adfFields);	
				}else{
					decryptedResponse = iciciUtil.compositeApiDecryption(response.toString(),adfFields);
				}
				...
				logger.info("Error while connecting Composite Api. Response Code is " + con.getResponseCode() + " txn id "
						+ fields.get(FieldType.TXN_ID.getName()));
				return null;
	...
	public String getIciciCompositeAccountStatementResponse(String request, String url, Fields fields, String apiKey, JSONObject adfFields)
			throws IOException {
		String decryptedResponse = null;
		HttpURLConnection con=null;
		StringBuffer response = new StringBuffer();
		try {
			...
			String encryptedRequest = iciciUtil.compositeApiEncryption(request,adfFields);
			logger.info(
					"Composite Encrypted Request is " + encryptedRequest+" "+request);
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				logger.info("Error while connecting Composite Api. Response Code is " + con.getResponseCode() + " "+request);
				return null;
	...
	public String getIciciCompositeNeftRtgsApiResponse(String request, String url, Fields fields, String priorty, String apiKey)
			throws IOException {
		String decryptedResponse = null;
		HttpURLConnection con=null;
		StringBuffer response = new StringBuffer();
	...
	public String getIciciCompositeNeftRtgsApiResponse(String request, String url, Fields fields, String priorty,
			String apiKey, JSONObject adfFields) {
		String decryptedResponse = null;
		HttpURLConnection con=null;
		StringBuffer response = new StringBuffer();
		try {
